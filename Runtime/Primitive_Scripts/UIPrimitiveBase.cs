...
namespace UIWidgets
{
    ...
    public class UIPrimitiveBase : MaskableGraphic, ILayoutElement, ICanvasRaycastFilter
    {
		...
		{
			DebugX.Builder(LogChannels.UI).WithContext(this).Error("Using clickAlphaThreshold lower than 1 on Image whose sprite texture cannot be read. {ErrorMessage} Also make sure to disable sprite packing for this sprite.", e.Message);
			return true;
		}
        }
